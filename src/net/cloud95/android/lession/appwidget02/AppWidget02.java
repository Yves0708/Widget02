...
public class AppWidget02 extends AppWidgetProvider {
    ...
    public static final String ACTION_UPDATE = 
            "net.cloud95.android.lession.appwidget02.ACTION.UPDATE";
    ...
    public void onReceive(Context context, Intent intent) {
    	...
    	if(action.equals(ACTION_UPDATE)){
    		Toast.makeText(context, "ACTION_UPDATE", Toast.LENGTH_SHORT).show();
    		
    		// 建立需要的AppWidgetManager物件，參數為Context物件
    		AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(context);
    		// 建立小工具元件的ComponentName物件,從當前APP跳到後面的類別
    ...
    public void onUpdate(Context context,
    	...
    	for(int i =0; i<appWidgetIds.length; i++){
    		...
    		// 設定網址
    		intentWeb.setData(Uri.parse("http://www.xcodeon.com"));
